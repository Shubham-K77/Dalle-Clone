      ...
      <div className="group-hover:flex flex-col justify-evenly items-start h-[16vh] bg-slate-900 w-full rounded-bl-md rounded-br-md shadow-md opacity-70 hidden">
        <div className="w-full flex justify-around items-center">
          <div className="w-full flex justify-start items-center">
            <div
              className="flex justify-center items-center w-[13.5%] lg:w-[12%] h-[5.5vh] lg:h-[6.05vh] bg-green-500 rounded-[50%] font-sans text-[1.75rem] lg:text-[2rem] text-white mt-[0.5rem] mb-[0.15rem] ml-[0.75rem] mr-[0.5rem] hover:bg-green-800 hover:cursor-pointer"
              title={name}
            >
              {letter}
            </div>
